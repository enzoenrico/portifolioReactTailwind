        ...
        <div>
          <div className='flex flex-wrap justify-center gap-2'>
            <a
              ...
              target='_blank'
              className='bg-pink-400 dark:bg-white dark:hover:bg-pink-400 p-2 hover:scale-105 font-semibold text-white dark:text-stone-900 inline-flex items-center space-x-2 rounded-full' rel="noreferrer"
            >
              <svg
            ...
            <a
              ...
              target='_blank'
              className='bg-pink-400 dark:bg-white dark:hover:bg-pink-400 hover:scale-105 p-2 font-semibold text-white dark:text-stone-900 inline-flex items-center space-x-2 rounded-full' rel="noreferrer"
            >
              <svg
                xmlns='http://www.w3.org/2000/svg'
