    ...
    return (
        <>
            <div className="p-3 my-2 max-w-xl">
                ...
                <div className="border-pink-500 border-2 border-t-0 bg-transparent box-border w-100 h-56 mx-0 my-auto p-7 rounded-b-md flex justify-center items-center flex-col">
                    ...
                    { imgUrl !== "" ? 
                        <img src={imgUrl} className=" border-2 border-green-500 rounded-md dark:bg-transparent bg-stone-900" />
                        : null
                    }
                </div>
            </div>
