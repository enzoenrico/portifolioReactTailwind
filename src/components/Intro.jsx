  ...
  return (
    <div className="flex items-center justify-center flex-col text-center pt-20 pb-6">
      ...
      <p className="text-small mw-w-1 mb-6 font-bold dark:bg-slate-200 bg-slate-800 dark:text-stone-800 text-white rounded-md p-4 md:m-2 sm: m-2">
        ...
        <a href="https://www.pucpr.br/cursos-graduacao/engenharia-de-software/" className="dark:text-blue-600 text-pink-500 hover:text-blue-900 hover:underline decoration-2 transition-colors duration-300 hover:cursor-pointer">
          @PUCPR {" "}
        </a>
         e estagiando{" "}
        <a href="https://www.akersolutions.com" className="dark:text-blue-600 text-pink-500 hover:text-blue-900 hover:underline decoration-2 transition-colors duration-300 hover:cursor-pointer">
          @AkerSolutions!
        </a>
