    ...
    <>
      <div className="mx-auto max-w-4xl px-6 py-10 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 rounded-2xl shadow-lg">
        <header className="mb-8">
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Last updated: August 22, 2025</p>
        </header>
        ...
        <article className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <ul>
            ...
            <li>
              <strong>Application</strong> refers to NanInf, the software program provided by the Company.
            </li>
            <li>
